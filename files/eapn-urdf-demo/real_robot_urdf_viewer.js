...
(() => {
  ...
  if(section?.nodeType===1&&section.isConnected)new MutationObserver(schedule).observe(section,{attributes:true,attributeFilter:['data-time']});
